...
public class JobPostActivityController {
		...
		if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
			...
			//for side bar
			 if (currentUserProfile instanceof RecruiterProfile) {
		            ...
		            model.addAttribute("country", recruiterProfile.getCountry());
		            model.addAttribute("city", recruiterProfile.getCity());
		            model.addAttribute("state", recruiterProfile.getState());
		            model.addAttribute("companyName", recruiterProfile.getCompany());
		        }
		} else {
	...
	@GetMapping("/Guest")
	public String out1(Model model) {
		Object currentUserProfile = usersService.getCurrentUserProfile();
		model.addAttribute("user", currentUserProfile);
