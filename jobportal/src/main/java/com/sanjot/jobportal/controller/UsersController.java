...
if(error!=null) {
	...
	public void generateStyledResume(
	        @RequestParam("templateId") int templateId, // Add template ID
	        ...
	        @RequestParam("skillName") List<String> skillName,
	        @RequestParam("skillExperience") List<String> skillExperience,
	        @RequestParam("skillLevel") List<String> skillLevel,
	        @RequestParam("projectName") List<String> projectName,
	        ...
	        @RequestParam("educationDescription") List<String> educationDescriptions,
	    ...
	    if (templateId == 1) {
	        ...
	        generateTemplate1(document, name, jobTitle, address, city, email, phone, summary, skillName, skillExperience, skillLevel, projectName, projectTime, projectDescription, experienceTitles, experienceDurations, experienceDescriptions, educationInstitutions, educationYears, educationDegrees, educationDescriptions);
	    } else if (templateId == 2) {
	        // Generate resume with Template 2 style
	        generateTemplate2(document, name, jobTitle, address, city, email, phone, summary, skillName, skillExperience, skillLevel, projectName, projectTime, projectDescription, experienceTitles, experienceDurations, experienceDescriptions, educationInstitutions, educationYears, educationDegrees, educationDescriptions);
	    } else if (templateId == 3) {
	        generateTemplate3(document, name, jobTitle, address, 
	        city, email, phone, summary, skillName, skillExperience, 
	        skillLevel, projectName, projectTime, projectDescription, 
	        experienceTitles, experienceDurations, experienceDescriptions,
	        educationInstitutions, educationYears, educationDegrees, 
	...
	private void generateTemplate3(
	        Document document,
	        String name,
	        String jobTitle,
	        String address,
	    ...
	    Font sectionFont = new Font(Font.FontFamily.HELVETICA, 14, Font.BOLD, new BaseColor(34, 139, 34)); // Forest green
	    ...
	    for (int i = 0; i < educationInstitutions.size(); i++) {
	        leftColumn.addElement(new Paragraph(
	                "• " + educationDegrees.get(i) + " at " + educationInstitutions.get(i) + " (" + educationYears.get(i) + ")",
	                textFont
	        ));
	    ...
	    for (int i = 0; i < projectName.size(); i++) {
	        rightColumn.addElement(new Paragraph(
	                "• " + projectName.get(i) + " (" + projectTime.get(i) + ")", textFont
	        ));
	    ...
	    for (int i = 0; i < experienceTitles.size(); i++) {
	        rightColumn.addElement(new Paragraph(
	                "• " + experienceTitles.get(i) + " (" + experienceDurations.get(i) + ")", textFont
	        ));
	...
	private void generateTemplate2(
	        Document document, String name, String jobTitle, String address, String city, String email, String phone,
	        String summary, List<String> skillName, List<String> skillExperience, List<String> skillLevel,
	        List<String> projectName, List<String> projectTime, List<String> projectDescription,
	        List<String> experienceTitles, List<String> experienceDurations, List<String> experienceDescriptions,
	        List<String> educationInstitutions, List<String> educationYears, List<String> educationDegrees, List<String> educationDescriptions
	) throws DocumentException {
	    ...
	    for (int i = 0; i < experienceTitles.size(); i++) {
	        Paragraph jobTitles = new Paragraph(experienceTitles.get(i), FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12));
	    ...
	    for (int i = 0; i < educationInstitutions.size(); i++) {
	        Paragraph institution = new Paragraph(educationInstitutions.get(i), FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12));
	        institution.setSpacingBefore(10);
	        document.add(institution);

	        Paragraph degree = new Paragraph(educationDegrees.get(i) + " (" + educationYears.get(i) + ")", subHeaderFont);
	        document.add(degree);
	    ...
	    for (int i = 0; i < skillName.size(); i++) {
	        document.add(new Paragraph(skillName.get(i) + " - " + skillExperience.get(i) + " years (" + skillLevel.get(i) + ")", bodyFont));
	    }
	    document.add(Chunk.NEWLINE);
